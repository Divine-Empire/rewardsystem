...
// Sample items data for the dropdown
const ITEMS_DATA = [
    ...
    <div className="hidden lg:block">
      {coupons.length === 0 ? (
        <div className="text-center py-12">
          <div className="w-14 h-14 mx-auto mb-3 rounded-2xl bg-gradient-to-br from-sky-100 to-sky-50 flex items-center justify-center">
        ...
        <div className="overflow-hidden rounded-xl border border-gray-100 shadow-sm">
          ...
          <div className="bg-gradient-to-r from-sky-600 to-sky-700 px-5 py-3">
            <div
              className={`grid ${
                showClaimInfo ? "grid-cols-9" : "grid-cols-7"
          ...
          <div className="max-h-80 overflow-y-auto bg-white divide-y divide-gray-50">
            {coupons.map((coupon, index) => (
              <div
                ...
                className={`grid ${
                  showClaimInfo ? "grid-cols-9" : "grid-cols-7"
                } gap-4 px-5 py-3.5 items-center hover:bg-sky-50/30 transition-colors ${
              ...
              >
                ...
                <div className="text-center">
                  <Button
                    ...
                    className="h-8 w-8 p-0 text-slate-400 hover:text-sky-600 hover:bg-sky-50 disabled:opacity-30 rounded-lg"
                  >
        ...
        coupons.map((coupon) => (
          ...
          >
            ...
            <Button
              ...
              className="w-full h-8 text-xs border border-sky-100 text-sky-500 hover:bg-sky-50 disabled:opacity-30"
            >
...
export default function PremiumAdminDashboard() {
  ...
  // Handle item selection - auto-fill item code
  const handleItemSelect = (itemName: string) => {
    setSelectedItemName(itemName);
    const selectedItem = ITEMS_DATA.find((item) => item.name === itemName);
    if (selectedItem) {
  ...
  const generateCoupons = async () => {
    ...
    try {
      ...
      currentCoupons.forEach((c: any) => existingCodes.add(c.code));
      ...
      // Use any[] to allow objects. The original code used array of arrays for sheets.
      ...
      const success = storageUtils.addCoupons(newCoupons);
      if (!success) throw new Error("Failed to save coupons to local storage");
  ...
  const confirmDeleteCoupon = async () => {
    ...
    try {
      // Use code to delete
      storageUtils.deleteCoupon(couponToDelete.code);
  ...
  if (isLoading && coupons.length === 0) {
    return (
      <div className="h-full flex items-center justify-center">
        <div className="text-center">
          <div className="w-12 h-12 mx-auto mb-4 rounded-2xl bg-gradient-to-br from-sky-500 to-sky-600 flex items-center justify-center shadow-lg shadow-sky-500/30">
  ...
  return (
    <div className="h-full flex flex-col gap-4 overflow-hidden">
            ...
            <div className="flex items-center gap-2 flex-wrap">
              ...
              <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
                <DialogTrigger asChild>
                  <Button
                    size="sm"
                    className="bg-gradient-to-r from-sky-500 to-sky-600 hover:from-sky-600 hover:to-sky-700 text-white shadow-md shadow-sky-500/25 border-0"
                  >
                ...
                <DialogContent className="sm:max-w-md">
                  ...
                  <div className="space-y-4 py-4">
                    <div className="space-y-2">
                      ...
                      >
                        <div className="w-6 h-6 rounded-lg bg-gradient-to-br from-sky-500 to-sky-600 flex items-center justify-center">
                          <Gift className="w-3.5 h-3.5 text-white" />
                        </div>
                        <span className="bg-gradient-to-r from-sky-600 to-sky-700 bg-clip-text text-transparent">
                          Item Name
                        </span>
                        <span className="ml-auto text-xs font-normal px-2 py-0.5 rounded-full bg-sky-100 text-sky-600">
                          Required
                        </span>
                      </Label>
                      <Select
                      ...
                      >
                        <SelectTrigger className="w-full h-11 rounded-xl border-slate-200 focus:border-sky-500 focus:ring-sky-500">
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        value={itemCode}
                        readOnly
                        placeholder="Auto-filled when item is selected"
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        className="h-11 rounded-xl border-slate-200 focus:border-sky-500 focus:ring-sky-500"
                      />
                    </div>
                    ...
                    <Button
                      ...
                      className="w-full h-11 bg-gradient-to-r from-sky-500 to-sky-600 hover:from-sky-600 hover:to-sky-700 text-white font-medium rounded-xl shadow-md"
                    >
                      {isGenerating ? (
                        <>
      ...
      <Dialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            <DialogTitle className="flex items-center gap-3 text-sky-600">
              <div className="w-10 h-10 rounded-xl bg-sky-100 flex items-center justify-center">
                <Trash2 className="w-5 h-5 text-sky-600" />
              </div>
              Delete Coupon
            </DialogTitle>
            <DialogDescription>
