    ...
    <div className="h-screen flex bg-slate-50 overflow-hidden">
      ...
      <aside className="hidden lg:flex w-64 bg-white border-r border-slate-200/60 z-30 flex-col shadow-xl shadow-slate-200/40">
        ...
        <div className="h-16 flex items-center gap-3 px-6 border-b border-slate-100 flex-shrink-0">
          <div className="w-8 h-8 rounded-lg overflow-hidden shadow-md shadow-sky-500/20 flex-shrink-0">
            <Image
              src="/logo.png"
              alt="Logo"
              width={32}
        ...
        <nav className="flex-1 px-4 space-y-2 overflow-y-auto">
          <button
            ...
            className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium transition-all duration-200 group ${
              activeView === "admin"
                ? "bg-sky-50 text-sky-600 shadow-sm ring-1 ring-sky-200"
        ...
        <div className="p-4 border-t border-slate-100">
          <Button
            ...
            className="w-full justify-start text-slate-500 hover:text-sky-600 hover:bg-sky-50 gap-3 px-4"
          >
      ...
      <main className="flex-1 overflow-hidden flex flex-col relative z-0">
        ...
        <div className="lg:hidden h-16 bg-white/80 backdrop-blur-md border-b border-slate-200/60 flex items-center justify-between px-4 flex-shrink-0 z-20 sticky top-0">
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 rounded-xl overflow-hidden shadow-lg shadow-sky-500/20 ring-2 ring-white">
              <Image
                src="/logo.png"
                alt="Logo"
                width={32}
          ...
          <Sheet>
            <SheetTrigger asChild>
              <Button
                variant="ghost"
                size="icon"
                className="text-slate-500 hover:text-sky-600 hover:bg-sky-50 rounded-xl"
              >
            ...
            >
              <div className="h-full flex flex-col">
                ...
                <div className="bg-gradient-to-br from-sky-600 to-sky-700 p-6 pt-10 text-white">
                  <div className="flex items-center gap-4 mb-4">
                    ...
                    <div>
                      ...
                      <p className="text-sky-100 text-xs font-medium uppercase tracking-wider bg-sky-800/30 px-2 py-0.5 rounded-full inline-block">
                        {currentUser?.role}
                      </p>
                    </div>
                  </div>
                ...
                <div className="p-4 border-t border-slate-100 bg-slate-50/50">
                  <Button
                    variant="ghost"
                    onClick={handleLogout}
                    className="w-full justify-start text-slate-500 hover:text-sky-600 hover:bg-sky-50 gap-3 px-4 h-11"
                  >
                    <LogOut className="w-5 h-5" />
                    Sign Out
                  </Button>
